...
- `hubs/codex/.codex-plugin/plugin.json`은 플러그인 메타데이터입니다.
- `hubs/codex/skills/`에는 adaptive orchestration, 문서 작성, GPT 연결, handoff, takeover,
  provider 위임 스킬이 있습니다.
- GPT가 별도 MCP가 아니라는 계약은 `hubs/codex/skills/gpt-provider/SKILL.md`에 있습니다.

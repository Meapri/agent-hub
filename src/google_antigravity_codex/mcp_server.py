...
COMPARE_SCHEMA: Dict[str, Any] = {
    ...
    "properties": {
        ...
        "max_tokens": {
            "type": "integer",
            "minimum": 32,
            "maximum": limits.GEMINI_MAX_OUTPUT_TOKENS,
...
CHAT_SCHEMA: Dict[str, Any] = {
    ...
    "properties": {
        ...
        "retry_count": {
            "type": "integer",
            "minimum": 0,
            "maximum": limits.MAX_PROVIDER_RETRIES,
            "default": limits.MAX_PROVIDER_RETRIES,
        },
...
GROUNDING_SCHEMA: Dict[str, Any] = {
    ...
    "properties": {
        ...
        "max_sources": {
            "type": "integer",
            "minimum": 1,
            "maximum": limits.MAX_SEARCH_SOURCES,
            "default": limits.MAX_SEARCH_SOURCES,
        },
        "freshness": {
            "type": "string",
